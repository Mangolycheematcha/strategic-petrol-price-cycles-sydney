...
figures/     Figures used in the report, including generated analysis figures
notebooks/   Reproducible FuelCheck raw-data demonstration notebook
data/raw/    Raw FuelCheck input data retained without notebook-side moves
data/processed/  Processed CSV output generated by the notebook
```
